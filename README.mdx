...
{links`
    ...
    @dalkak2/enz-pixi: Performant EntryJS Runtime (2023-2025)
...
### Utility
{links`
    twilight.js: Twilight Colormap (2024)
    kml.ts: KML Parser, Typed (2025)
`}
...
export const love =
([items]) =>
    `<img height="20px" src="./Heart.svg"/><img height="20px" src="https://skillicons.dev/icons?i=${items}"/>`
